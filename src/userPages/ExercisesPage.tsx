...
type Exercise = {
  muscle: string;
  title: string;
  equipment: Exclude<Equipment, "">;
  difficulty: Exclude<Difficulty, "">;

  // recommendation helpers
  priority: 1 | 2 | 3; // 1=Top Pick, 2=Variation, 3=Finisher
...
// English muscle names (you kept them as English labels)
...
const EXERCISES: Exercise[] = [
  ...
  // CHEST
  // =======================
  { muscle: "chest", title: "Barbell Bench Press", equipment: "barbell", difficulty: "intermediate", priority: 1, kind: "compound", youtubeId: "gRVjAtPip0Y" },
  { muscle: "chest", title: "Incline Barbell Press", equipment: "barbell", difficulty: "intermediate", priority: 2, kind: "compound", youtubeId: "SrqOu55lrYU" },
  { muscle: "chest", title: "Close-Grip Bench Press (Chest/Triceps)", equipment: "barbell", difficulty: "intermediate", priority: 3, kind: "compound", youtubeId: "J0DnG1_S92I" },

  { muscle: "chest", title: "Dumbbell Chest Press", equipment: "dumbbell", difficulty: "beginner", priority: 1, kind: "compound", youtubeId: "VmB1G1K7v94" },
  { muscle: "chest", title: "Incline Dumbbell Press", equipment: "dumbbell", difficulty: "intermediate", priority: 2, kind: "compound", youtubeId: "8iPEnn-ltC8" },
  { muscle: "chest", title: "Dumbbell Fly", equipment: "dumbbell", difficulty: "beginner", priority: 3, kind: "isolation", youtubeId: "eozdVDA78K0" },

  { muscle: "chest", title: "Cable Chest Fly", equipment: "cable", difficulty: "beginner", priority: 1, kind: "isolation", youtubeId: "Iwe6AmxVf7o" },
  { muscle: "chest", title: "Low-to-High Cable Fly", equipment: "cable", difficulty: "intermediate", priority: 2, kind: "isolation", youtubeId: "eQ_NBB6OBH4" }, // ✅ fixed
  { muscle: "chest", title: "Cable Press (Standing)", equipment: "cable", difficulty: "intermediate", priority: 3, kind: "compound", youtubeId: "v5uOhBE1oCk" }, // ✅ fixed

  { muscle: "chest", title: "Push-Up", equipment: "bodyweight", difficulty: "beginner", priority: 1, kind: "compound", youtubeId: "IODxDxX7oi4" },
  { muscle: "chest", title: "Decline Push-Up (Variation)", equipment: "bodyweight", difficulty: "intermediate", priority: 2, kind: "compound", youtubeId: "SKPab2YC8BE" },
  { muscle: "chest", title: "Band Chest Press (Finisher)", equipment: "band", difficulty: "beginner", priority: 3, kind: "compound", youtubeId: "9NGo4lZd65o" }, // ✅ fixed

  // =======================
  // BICEPS
  // =======================
  { muscle: "biceps", title: "Dumbbell Curl", equipment: "dumbbell", difficulty: "beginner", priority: 1, kind: "isolation", youtubeId: "ykJmrZ5v0Oo" },
  { muscle: "biceps", title: "Hammer Curl", equipment: "dumbbell", difficulty: "beginner", priority: 2, kind: "isolation", youtubeId: "zC3nLlEvin4" },
  { muscle: "biceps", title: "Concentration Curl (Finisher)", equipment: "dumbbell", difficulty: "beginner", priority: 3, kind: "isolation", youtubeId: "0AUGkch3tzc" },

  { muscle: "biceps", title: "Barbell Curl", equipment: "barbell", difficulty: "beginner", priority: 1, kind: "isolation", youtubeId: "kwG2ipFRgfo" },
  { muscle: "biceps", title: "EZ-Bar Curl (Alt)", equipment: "barbell", difficulty: "intermediate", priority: 2, kind: "isolation", youtubeId: "4zVCOcypCac" }, // ✅ fixed
  { muscle: "biceps", title: "21s Curl (Finisher)", equipment: "barbell", difficulty: "intermediate", priority: 3, kind: "isolation", youtubeId: "pHryIMHL-eY" }, // ✅ fixed

  { muscle: "biceps", title: "Cable Curl", equipment: "cable", difficulty: "beginner", priority: 1, kind: "isolation", youtubeId: "NFzTWp2qpiE" },
  { muscle: "biceps", title: "Rope Hammer Curl (Variation)", equipment: "cable", difficulty: "beginner", priority: 2, kind: "isolation", youtubeId: "VYXqaMnPocs" }, // ✅ fixed
  { muscle: "biceps", title: "Band Curl (Finisher)", equipment: "band", difficulty: "beginner", priority: 3, kind: "isolation", youtubeId: "RyWX9e7imhc" }, // ✅ fixed

  // =======================
  // TRICEPS
  // =======================
  { muscle: "triceps", title: "Rope Triceps Pushdown", equipment: "cable", difficulty: "beginner", priority: 1, kind: "isolation", youtubeId: "-KVa3M1uZfs" },
  { muscle: "triceps", title: "Straight-Bar Pushdown (Variation)", equipment: "cable", difficulty: "beginner", priority: 2, kind: "isolation", youtubeId: "2-LAMcpzODU" },
  { muscle: "triceps", title: "Overhead Rope Extension (Finisher)", equipment: "cable", difficulty: "intermediate", priority: 3, kind: "isolation", youtubeId: "l4i7iDLiMXs" }, // ✅ fixed

  { muscle: "triceps", title: "Close-Grip Bench Press", equipment: "barbell", difficulty: "intermediate", priority: 1, kind: "compound", youtubeId: "J0DnG1_S92I" },
  { muscle: "triceps", title: "Skull Crushers (EZ/Barbell)", equipment: "barbell", difficulty: "intermediate", priority: 2, kind: "isolation", youtubeId: "d_KZxkY_0cM" },
  { muscle: "triceps", title: "Bench Dips (Finisher)", equipment: "bodyweight", difficulty: "beginner", priority: 3, kind: "compound", youtubeId: "0326dy_-CzM" },

  { muscle: "triceps", title: "Dumbbell Overhead Extension", equipment: "dumbbell", difficulty: "beginner", priority: 1, kind: "isolation", youtubeId: "YbX7Wd8jQ-Q" },
  { muscle: "triceps", title: "Dumbbell Kickback (Variation)", equipment: "dumbbell", difficulty: "beginner", priority: 2, kind: "isolation", youtubeId: "6SS6K3lAwZ8" },
  { muscle: "triceps", title: "Band Pushdown (Finisher)", equipment: "band", difficulty: "beginner", priority: 3, kind: "isolation", youtubeId: "_XItFeQzxD8" }, // ✅ fixed

  // =======================
  // FRONT SHOULDERS
  // =======================
  { muscle: "front-shoulders", title: "Dumbbell Shoulder Press", equipment: "dumbbell", difficulty: "beginner", priority: 1, kind: "compound", youtubeId: "qEwKCR5JCog" },
  { muscle: "front-shoulders", title: "Arnold Press (Variation)", equipment: "dumbbell", difficulty: "intermediate", priority: 2, kind: "compound", youtubeId: "vj2w851ZHRM" },
  { muscle: "front-shoulders", title: "Dumbbell Front Raise (Finisher)", equipment: "dumbbell", difficulty: "beginner", priority: 3, kind: "isolation", youtubeId: "-t7fuZ0KhDA" },

  { muscle: "front-shoulders", title: "Overhead Press", equipment: "barbell", difficulty: "intermediate", priority: 1, kind: "compound", youtubeId: "2yjwXTZQDDI" },
  { muscle: "front-shoulders", title: "Push Press (Variation)", equipment: "barbell", difficulty: "advanced", priority: 2, kind: "compound", youtubeId: "iaBVSJm78ko" },
  { muscle: "front-shoulders", title: "Pike Push-Up (Finisher)", equipment: "bodyweight", difficulty: "intermediate", priority: 3, kind: "compound", youtubeId: "Im892MaSRKg" }, // ✅ fixed

  { muscle: "front-shoulders", title: "Band Overhead Press", equipment: "band", difficulty: "beginner", priority: 1, kind: "compound", youtubeId: "bC4XNIiOxcQ" }, // ✅ fixed
  { muscle: "front-shoulders", title: "Band Front Raise (Variation)", equipment: "band", difficulty: "beginner", priority: 2, kind: "isolation", youtubeId: "x5WVhdGUBH4" }, // ✅ fixed
  { muscle: "front-shoulders", title: "Band Lateral Raise (Finisher)", equipment: "band", difficulty: "beginner", priority: 3, kind: "isolation", youtubeId: "t2b8UdqmlFs" },

  // =======================
  // REAR SHOULDERS
  // =======================
  { muscle: "rear-shoulders", title: "Cable Face Pull", equipment: "cable", difficulty: "beginner", priority: 1, kind: "compound", youtubeId: "0Po47vvj9g4" },
  { muscle: "rear-shoulders", title: "Reverse Cable Fly (Variation)", equipment: "cable", difficulty: "beginner", priority: 2, kind: "isolation", youtubeId: "vB5OHsJ3EME" },
  { muscle: "rear-shoulders", title: "Band Face Pull (Finisher)", equipment: "band", difficulty: "beginner", priority: 3, kind: "compound", youtubeId: "GZbfZ033f74" },

  { muscle: "rear-shoulders", title: "Dumbbell Rear Delt Fly", equipment: "dumbbell", difficulty: "beginner", priority: 1, kind: "isolation", youtubeId: "lPt0GqwaqEw" }, // ✅ fixed
  { muscle: "rear-shoulders", title: "Chest-Supported Rear Delt Fly (Variation)", equipment: "dumbbell", difficulty: "intermediate", priority: 2, kind: "isolation", youtubeId: "R5JwRvN6BDw" }, // ✅ fixed
  { muscle: "rear-shoulders", title: "Prone Y-T Raises (Finisher)", equipment: "bodyweight", difficulty: "beginner", priority: 3, kind: "isolation", youtubeId: "qL304NG5Sus" }, // ✅ fixed

  // =======================
  // TRAPS + TRAPS-MIDDLE
  // =======================
  { muscle: "traps", title: "Dumbbell Shrug", equipment: "dumbbell", difficulty: "beginner", priority: 1, kind: "isolation", youtubeId: "_ZqnTO5NlTY" },
  { muscle: "traps", title: "Kettlebell Farmer Carry", equipment: "kettlebell", difficulty: "intermediate", priority: 2, kind: "compound", youtubeId: "Fkzk_RqlYig" },
  { muscle: "traps", title: "Suitcase Carry (Finisher)", equipment: "kettlebell", difficulty: "intermediate", priority: 3, kind: "compound", youtubeId: "iq5D5SU2Oq4" }, // ✅ fixed

  { muscle: "traps-middle", title: "Barbell Bent-Over Row", equipment: "barbell", difficulty: "intermediate", priority: 1, kind: "compound", youtubeId: "qXrTDQG1oUQ" },
  { muscle: "traps-middle", title: "Seated Cable Row", equipment: "cable", difficulty: "beginner", priority: 2, kind: "compound", youtubeId: "UM2hfR5Wrpw" },
  { muscle: "traps-middle", title: "Band Row (Finisher)", equipment: "band", difficulty: "beginner", priority: 3, kind: "compound", youtubeId: "NMGuA6Q8q_o" },

  // =======================
  // LATS + LOWER BACK
  // =======================
  { muscle: "lats", title: "Lat Pulldown", equipment: "machine", difficulty: "beginner", priority: 1, kind: "compound", youtubeId: "bNmvKpJSWKM" },
  { muscle: "lats", title: "Pull-Up", equipment: "bodyweight", difficulty: "intermediate", priority: 2, kind: "compound", youtubeId: "n3ecMH8E5U8" },
  { muscle: "lats", title: "Single-Arm Dumbbell Row (Finisher)", equipment: "dumbbell", difficulty: "beginner", priority: 3, kind: "compound", youtubeId: "gfUg6qWohTk" },

  { muscle: "lowerback", title: "Barbell Romanian Deadlift (RDL)", equipment: "barbell", difficulty: "intermediate", priority: 1, kind: "compound", youtubeId: "lC9FNwuXJpo" },
  { muscle: "lowerback", title: "Back Extension", equipment: "machine", difficulty: "beginner", priority: 2, kind: "compound", youtubeId: "dF_V3358Dkc" },
  { muscle: "lowerback", title: "Good Morning (Light Finisher)", equipment: "barbell", difficulty: "advanced", priority: 3, kind: "compound", youtubeId: "gJikDHZrlMw" }, // ✅ fixed

  // =======================
  // QUADS
  // =======================
  { muscle: "quads", title: "Back Squat", equipment: "barbell", difficulty: "intermediate", priority: 1, kind: "compound", youtubeId: "Dy28eq2PjcM" },
  { muscle: "quads", title: "Front Squat (Variation)", equipment: "barbell", difficulty: "advanced", priority: 2, kind: "compound", youtubeId: "npVgCT7NznU" }, // ✅ fixed
  { muscle: "quads", title: "Pause Squat (Finisher)", equipment: "barbell", difficulty: "advanced", priority: 3, kind: "compound", youtubeId: "5Puq2t0-Xpw" }, // ✅ fixed

  { muscle: "quads", title: "Leg Extension", equipment: "machine", difficulty: "beginner", priority: 1, kind: "isolation", youtubeId: "YyvSfVjQeL0" },
  { muscle: "quads", title: "Leg Press (Variation)", equipment: "machine", difficulty: "beginner", priority: 2, kind: "compound", youtubeId: "IZxyjW7MPJQ" },
  { muscle: "quads", title: "Goblet Squat (Finisher)", equipment: "kettlebell", difficulty: "beginner", priority: 3, kind: "compound", youtubeId: "MeIiIdhvXT4" },

  // =======================
  // HAMSTRINGS
  // =======================
  { muscle: "hamstrings", title: "Barbell Romanian Deadlift (RDL)", equipment: "barbell", difficulty: "intermediate", priority: 1, kind: "compound", youtubeId: "lC9FNwuXJpo" },
  { muscle: "hamstrings", title: "Seated Leg Curl Machine", equipment: "machine", difficulty: "beginner", priority: 2, kind: "isolation", youtubeId: "ysiJ7mSYBZc" },
  { muscle: "hamstrings", title: "Band Leg Curl (Finisher)", equipment: "band", difficulty: "beginner", priority: 3, kind: "isolation", youtubeId: "kEEzzNwFg3E" }, // ✅ fixed

  // =======================
  // GLUTES
  // =======================
  { muscle: "glutes", title: "Barbell Hip Thrust", equipment: "barbell", difficulty: "intermediate", priority: 1, kind: "compound", youtubeId: "kUqd_ho2ZKg" },
  { muscle: "glutes", title: "Kettlebell Swing (Variation)", equipment: "kettlebell", difficulty: "intermediate", priority: 2, kind: "compound", youtubeId: "YSxHifyI6s8" },
  { muscle: "glutes", title: "Band Glute Bridge (Finisher)", equipment: "band", difficulty: "beginner", priority: 3, kind: "compound", youtubeId: "gRvCXuZrURs" }, // ✅ fixed

  // =======================
  // CALVES
  // =======================
  { muscle: "calves", title: "Standing Calf Raise", equipment: "bodyweight", difficulty: "beginner", priority: 1, kind: "isolation", youtubeId: "3iQEBOj1L1M" },
  { muscle: "calves", title: "Calf Raise (Dumbbells)", equipment: "dumbbell", difficulty: "beginner", priority: 2, kind: "isolation", youtubeId: "qmihweq30nA" },
  { muscle: "calves", title: "Seated Calf Raise (Machine Finisher)", equipment: "machine", difficulty: "beginner", priority: 3, kind: "isolation", youtubeId: "M8v2dYNVdnw" },

  // =======================
  // ABDOMINALS
  // =======================
  { muscle: "abdominals", title: "Crunch", equipment: "bodyweight", difficulty: "beginner", priority: 1, kind: "isolation", youtubeId: "Xyd_fa5zoEU" },
  { muscle: "abdominals", title: "Hanging Knee Raise (Variation)", equipment: "bodyweight", difficulty: "intermediate", priority: 2, kind: "compound", youtubeId: "hdng3Nm1x_E" },
  { muscle: "abdominals", title: "Plank (Finisher)", equipment: "bodyweight", difficulty: "beginner", priority: 3, kind: "compound", youtubeId: "pSHjTRCQxIw" },

  // =======================
  // OBLIQUES
  // =======================
  { muscle: "obliques", title: "Cable Woodchop", equipment: "cable", difficulty: "intermediate", priority: 1, kind: "compound", youtubeId: "pAplQXk3dkU" },
  { muscle: "obliques", title: "Cable Pallof Press (Variation)", equipment: "cable", difficulty: "beginner", priority: 2, kind: "compound", youtubeId: "xeFp4MXad98" }, // ✅ fixed
  { muscle: "obliques", title: "Side Plank (Finisher)", equipment: "bodyweight", difficulty: "beginner", priority: 3, kind: "compound", youtubeId: "K2VljzCC16g" },

  // =======================
  // FOREARMS
  // =======================
  { muscle: "forearms", title: "Dead Hang (Grip Builder)", equipment: "bodyweight", difficulty: "beginner", priority: 1, kind: "compound", youtubeId: "0HBhuaD_S7M" },
  { muscle: "forearms", title: "Dumbbell Wrist Curl (Variation)", equipment: "dumbbell", difficulty: "beginner", priority: 2, kind: "isolation", youtubeId: "3VLTzIrnb5g" },
  { muscle: "forearms", title: "Farmer Carry (Finisher)", equipment: "kettlebell", difficulty: "intermediate", priority: 3, kind: "compound", youtubeId: "Fkzk_RqlYig" },

  // =======================
  // HANDS (Grip / carry / hold)
  // =======================
  { muscle: "hands", title: "Dead Hang (Hands/Grip)", equipment: "bodyweight", difficulty: "beginner", priority: 1, kind: "compound", youtubeId: "0HBhuaD_S7M" },
  { muscle: "hands", title: "Suitcase Carry", equipment: "kettlebell", difficulty: "intermediate", priority: 2, kind: "compound", youtubeId: "iq5D5SU2Oq4" }, // ✅ fixed
  { muscle: "hands", title: "Towel Hang (Finisher)", equipment: "bodyweight", difficulty: "advanced", priority: 3, kind: "compound", youtubeId: "OT-wTpxP9uo" },
];


function muscleLabel(id: string) {
  return NAMES_AR[id] ? `${id} — ${NAMES_AR[id]}` : id;
}
...
type EquipmentUIKey = (typeof EQUIPMENT_UI)[number]["key"];

const EQUIP_LABEL: Record<Exclude<Equipment, "">, string> = {
  barbell: "Barbell",
  dumbbell: "Dumbbells",
...
export default function ExercisesPage() {
  ...
  // Multi-select equipment (default: all selected = "شغالين")
  const [equipmentSelected, setEquipmentSelected] = useState<
    Set<Exclude<Equipment, "">>
  >(
    () =>
      new Set([
        "barbell",
  ...
  const toggleEquipmentUI = (k: EquipmentUIKey) => {
  ...
  // gather muscle ids from the displayed SVG
  const muscleIds = useMemo(() => {
    ...
    if (!s) return [];
    return Array.from(s.querySelectorAll("g.bodymap[id]"))
      .map((g) => (g as SVGGElement).id)
      .filter((id) => id && id !== "body");
  }, [isMale, viewMode, svgRef.current, backSvgRef.current]);

  const filteredMuscles = useMemo(() => {
    const q = search.trim().toLowerCase();
    return (muscleIds.length ? muscleIds : Object.keys(NAMES_AR)).filter((id) => {
      if (!q) return true;
      return muscleLabel(id).toLowerCase().includes(q);
    });
  }, [muscleIds, search]);
  ...
  const filteredExercises = useMemo(() => {
    ...
    return EXERCISES.filter((x) => {
      const okMuscle = x.muscle === selected;
      const okEquip = equipmentSelected.size ? equipmentSelected.has(x.equipment) : true;
      const okDifficulty = !difficulty || x.difficulty === difficulty;
      return okMuscle && okEquip && okDifficulty;
    }).sort((a, b) => {
      // priority asc then compound first
      if (a.priority !== b.priority) return a.priority - b.priority;
      if (a.kind !== b.kind) return a.kind === "compound" ? -1 : 1;
      return a.title.localeCompare(b.title);
    });
  }, [selected, equipmentSelected, difficulty]);

  // group by equipment => each equipment shows Top/Variation/Finisher
  const groupedByEquipment = useMemo(() => {
    const map = new Map<Exclude<Equipment, "">, Exercise[]>();
    for (const ex of filteredExercises) {
      const arr = map.get(ex.equipment) ?? [];
      arr.push(ex);
      map.set(ex.equipment, arr);
    }
    return Array.from(map.entries()).sort((a, b) =>
      EQUIP_LABEL[a[0]].localeCompare(EQUIP_LABEL[b[0]])
    );
  }, [filteredExercises]);

  // highlight selected/dim behavior
  useEffect(() => {
    const s = isMale
      ? viewMode === "front"
        ? svgRef.current
    ...
    const groups = Array.from(s.querySelectorAll("g.bodymap")) as SVGGElement[];

    groups.forEach((g) => g.classList.remove("selected"));
    if (selected) {
      const g = s.querySelector(`g#${CSS.escape(selected)}.bodymap`) as SVGGElement | null;
      g?.classList.add("selected");
    }

    if (dimMode && selected) s.classList.add("dim");
    else s.classList.remove("dim");
  }, [selected, dimMode, isMale, viewMode]);
  ...
  useEffect(() => {
    ...
    const handler = (e: any) => {
      const g: SVGGElement | null = e.target?.closest?.("g.bodymap");
      if (!g?.id || g.id === "body") return;
      setSelected(g.id);
    };

    s.addEventListener("click", handler);
    return () => s.removeEventListener("click", handler);
  }, [isMale, viewMode]);

  const titleText = selected
    ? NAMES_AR[selected]
      ? `${selected} (${NAMES_AR[selected]})`
      : selected
    : "Select a muscle";

  return (
    <MainLayout title="Exercises" subtitle="Muscle Map & Exercise Library">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        {/* Left Panel */}
        <Card className="lg:col-span-4 lg:sticky lg:top-20 h-fit overflow-hidden">
          {/* top bar */}
          <div className="bg-[#1f3f99] px-4 pt-4 pb-3">
            <div className="grid grid-cols-3 gap-3 text-white">
              <button
                type="button"
                onClick={() => setIsMale((v) => !v)}
                className={cn(
                  "rounded-xl px-6 py-3 text-center transition-all duration-300",
                  "font-semibold",
                  isMale
              ...
              >
                <div className="mx-auto mb-2 flex h-7 w-14 items-center rounded-full bg-white/30 p-1">
                  <span
                    className={cn(
                      "h-5 w-5 rounded-full bg-white transition-all duration-300",
                      isMale ? "translate-x-0" : "translate-x-7"
                    )}
                  />
                </div>
                {isMale ? "Male" : "Female"}
          ...
          <CardContent className="p-0">
            ...
            <div className="border-t">
              ...
              >
                <span className="text-base font-semibold">Equipment</span>
              ...
              {equipmentOpen && (
                <div className="px-4 pb-4">
                  <div className="grid grid-cols-2 gap-x-6 gap-y-3">
                    {EQUIPMENT_UI.map((it) => {
                      const checked = equipmentSelected.has(it.key);
                      return (
                        <label
                          key={it.key}
                        ...
                        >
                          <input
                            type="checkbox"
                            checked={checked}
                            onChange={() => toggleEquipmentUI(it.key)}
                            className="h-4 w-4 rounded border border-input"
                          />
                          <span className="inline-flex h-6 w-6 items-center justify-center rounded-md bg-muted/40 text-muted-foreground">
                            <span className="h-2 w-2 rounded-full bg-muted-foreground/60" />
                          </span>
                          <span className={cn("text-sm", checked && "font-semibold")}>
                            {it.label}
                          </span>
                        </label>
                      );
            ...
            <div className="px-4 pb-4">
              <div className="mt-3 space-y-3">
                <div>
                  <Label className="text-sm">Muscle Search</Label>
                  <Input
                    value={search}
                    onChange={(e) => setSearch(e.target.value)}
                    placeholder="Ex : abdominals"
                    className="mt-1"
                  />
                </div>

                <div className="flex flex-wrap gap-2">
                  {filteredMuscles.map((id) => (
                    <button
                      key={id}
                      type="button"
                ...
                <div className="text-sm font-semibold mt-2">{titleText}</div>
                <div className="text-xs text-muted-foreground">
Select a muscle + equipment → we’ll suggest multiple exercises using the same equipment.                </div>
              </div>
            </div>
          </CardContent>
        </Card>
...
Hover to highlight — Click to select.              </span>
            </CardTitle>
          </CardHeader>
          ...
          <CardContent>
              ...
              viewMode === "front" ? (
                <>
                  <style>{`
                    ...
                    .muscleSvg g#body{ pointer-events: none; }
                    .muscleSvg g.hidden{ pointer-events: none; display:none !important; }
                    .muscleSvg g.bodymap:hover{
                      color: hsl(var(--foreground));
                      filter: drop-shadow(0 10px 16px rgba(110,231,255,.12));
                    }
                    .muscleSvg g.bodymap.selected{
                      color: hsl(var(--primary));
                      filter: drop-shadow(0 14px 22px rgba(0,0,0,.20));
                    }
                    .muscleSvg.dim g.bodymap{ opacity: .28; }
                    .muscleSvg.dim g.bodymap.selected{ opacity: 1; }
                  `}</style>

                  <div className="w-full rounded-xl border bg-muted/10 p-3 overflow-auto">
                    {/* ======= Male Front SVG (as-is from your file) ======= */}
              <svg
                ref={svgRef}
                className={cn("muscleSvg w-full max-w-[560px] mx-auto h-auto w-full mc:h-[700px] 2xl:h-[90vh] 3xl:h-[95vh] 4xl:h-screen sm:mx-auto object-fit")}
            ...
            <div className="mt-6 border-t pt-4">
              <div className="flex items-center justify-between gap-3 mb-2">
                <div className="font-semibold">Suggested Exercises</div>
                <div className="text-xs text-muted-foreground">
Tap on any exercise to open the tutorial video.                </div>
              </div>

              {!selected ? (
                <div className="text-sm text-muted-foreground">
Select a muscle from the map to display the exercises.                </div>
              ) : equipmentSelected.size === 0 ? (
                <div className="text-sm text-muted-foreground">
Select at least one piece of equipment from the left.                </div>
              ) : filteredExercises.length === 0 ? (
                <div className="text-sm text-muted-foreground">
There are no exercises available for this muscle with the selected equipment     
           </div>
              ) : (
                <div className="space-y-6">
                  {groupedByEquipment.map(([equip, list]) => {
                    const top = list.filter((x) => x.priority === 1);
                    const vars = list.filter((x) => x.priority === 2);
                    const fin = list.filter((x) => x.priority === 3);
                    ...
                    return (
                      <div key={equip} className="rounded-xl border p-4 bg-muted/10">
                        <div className="flex items-center justify-between">
                          <div className="font-semibold">{EQUIP_LABEL[equip]}</div>
                          <div className="text-xs text-muted-foreground">
                            {list.length} exercise{list.length > 1 ? "s" : ""}
                          </div>
                        </div>

                        <Section title="Top Picks" items={top} />
                        <Section title="Variations" items={vars} />
                        <Section title="Finisher" items={fin} />
                      </div>
                    );
                  })}
                </div>
      ...
      {activeExercise && (
        <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center p-4">
          <div className="bg-background w-full max-w-2xl rounded-xl p-4 relative">
            <button
            ...
            <div className="text-xs text-muted-foreground mb-3">
              {EQUIP_LABEL[activeExercise.equipment]} • {activeExercise.kind} •{" "}
