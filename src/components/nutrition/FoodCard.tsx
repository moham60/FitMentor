...
const FoodCard = ({ food, onAddFood }: FoodCardProps) => {
  ...
  const displayName = food.name_en || food.name_ar;
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground truncate">{food.name_ar}</p>
        ...
        <DialogHeader>
          <DialogTitle className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-normal text-muted-foreground">{food.name_ar}</p>
            </div>
          </DialogTitle>
        </DialogHeader>
