    ...
    <>
      ...
      {view === "front" ? (
        <svg
          ref={svgRef}
          className={cn(
            "femalMuscleSvg w-full max-w-[560px] mx-auto h-auto w-full mc:h-[700px] 2xl:h-[90vh] 3xl:h-[95vh] 4xl:min-h-[100dvh] sm:mx-auto object-fit",
            dimmed && "dim"
          )}
          onClick={(e) => {
